...
export default function TermsAndConditionsPage() {
    ...
    return termsData.parts
      .map(part => {
        const matchingSections = part.sections.filter(sec => {
          ...
          const matchesClause = sec.clauses.some(
            c => c.num.toLowerCase().includes(q) || c.text.toLowerCase().includes(q)
          );
  ...
  const totalMatches = useMemo(() => {
    ...
    return filteredParts.reduce((acc, part) => acc + part.sections.length, 0);
            ...
            <div className="space-y-6">
              ...
              {searchQuery && (
                <div className="font-mono text-[11px] text-[#5B5F66] px-1">
                  Found <span className="font-bold text-red">{totalMatches}</span> section(s) matching &quot;{searchQuery}&quot;
                </div>
              )}
              ...
              <div className="space-y-3">
                ...
                <nav className="space-y-1 text-xs font-mono">
                  {termsData.parts.map(part => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left py-2 px-2.5 transition-all flex items-center justify-between group ${
                          isActive
                  ...
                  <button
                    ...
                    className={`w-full text-left py-2 px-2.5 transition-colors flex items-center justify-between font-mono ${
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="bg-white border border-line p-6 sm:p-8 shadow-xs">
              ...
              <div className="mb-6 p-3.5 bg-paper-off border-l-4 border-l-blue text-xs font-mono text-[#4B515D] leading-relaxed space-y-1">
                ...
                <p>
                  These Terms govern use of the website, mobile applications, and partner portals operated by Speedy Meals Delivery Services (under DiscoverTheTech). All registered users, partners, and customers agree to these terms upon onboarding.
                </p>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-line grid grid-cols-1 sm:grid-cols-3 gap-3 font-mono text-xs">
                <div className="p-3.5 bg-[#F8F9FA] border border-line">
                  ...
                  <div className="text-[11px] text-[#5B5F66] leading-relaxed">
                    100% retained customer delivery fare. Standard Rs. 10 flat app fee per completed delivery (Clause D3).
                  </div>
                </div>
                ...
                <div className="p-3.5 bg-[#F8F9FA] border border-line">
                  ...
                  <div className="text-[11px] text-[#5B5F66] leading-relaxed">
                    Flat 10% platform commission. Zero signup fees, weekly automated settlements every Monday (Clause E5).
                  </div>
                </div>
                ...
                <div className="p-3.5 bg-[#F8F9FA] border border-line">
                  ...
                  <div className="text-[11px] text-[#5B5F66] leading-relaxed">
                    Zero hidden markups on restaurant menu prices. Transparent distance-based delivery fee calculations (Clause C3).
                  </div>
                </div>
              </div>
            </div>
